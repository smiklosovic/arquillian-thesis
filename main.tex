...
%\lstinputlisting[language=Java,label=pop-pipe,caption=A test java file]{src/test.java}
...
what it is, unit testing, how unit tests should be written, simple unit test + explain		
