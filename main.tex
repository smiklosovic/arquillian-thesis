...
In the following section, the detailed description of container lifecycle will be given. 
		...
		\subsection{Extension for multiple containers}
...
After the explanation of the internal workings of Android container, we are going to show the reader possible use cases how Android container abstraction can be used. Various scenarios are discussed.
